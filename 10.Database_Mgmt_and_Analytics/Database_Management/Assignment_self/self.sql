...
--FROM LMS_MEMBERS WHERE MEMBERSHIP_STATUS like 'Permanent'
...
--SELECT LM.MEMBER_ID , LM.MEMBER_NAME , BI.BOOK_CODE FROM LMS_MEMBERS LM FULL JOIN LMS_BOOK_ISSUE BI ON (LM.MEMBER_ID=BI.MEMBER_ID) WHERE BOOK_CODE = 'BL000002'


--Problem # 4: Write a query to display the book code, book title and author of the books whose author name begins with 'P'.
--SELECT BD.BOOK_CODE , BD.BOOK_TITLE , BD.AUTHOR FROM LMS_BOOK_DETAILS BD WHERE AUTHOR LIKE'P%'
...
--SELECT CATEGORY , COUNT(*) NO_OF_BOOKS FROM LMS_BOOK_DETAILS WHERE CATEGORY ='JAVA' GROUP BY CATEGORY 
...
--SELECT CATEGORY , COUNT (CATEGORY) NO_OF_BOOKS FROM LMS_BOOK_DETAILS GROUP BY CATEGORY HAVING COUNT(CATEGORY)>2


-- Problem # 7: Write a query to display the number of books published by "Prentice Hall” with the alias name “NO_OF_BOOKS”.
--SELECT PUBLICATION , COUNT(PUBLICATION) NO_OF_BOOKS FROM LMS_BOOK_DETAILS GROUP BY PUBLICATION HAVING PUBLICATION LIKE 'Prentice Hall'


-- Problem # 8: Write a query to display the book code, book title of the books which are issued on the date "1st April 2012".
--SELECT BD.BOOK_CODE, BD.BOOK_TITLE , BI.DATE_ISSUE FROM LMS_BOOK_DETAILS BD INNER JOIN LMS_BOOK_ISSUE BI ON(BD.BOOK_CODE=BI.BOOK_CODE) WHERE DATE_ISSUE = TO_DATE('01-04-2012','DD-MM-YY')
...
--SELECT MEMBER_ID, MEMBER_NAME, DATE_REGISTER, DATE_EXPIRE FROM LMS_MEMBERS WHERE DATE_EXPIRE < TO_DATE('03-04-13','DD-MM-YY') 
...
--SELECT MEMBER_ID , MEMBER_NAME, DATE_REGISTER, DATE_EXPIRE  FROM LMS_MEMBERS WHERE DATE_REGISTER < TO_DATE('03-2012','mm-yyyy') and upper(MEMBERSHIP_STATUS) = upper('Temporary')
...
--SELECT member_id, member_name, city FROM lms_members WHERE initcap(city) IN ('Chennai', 'Delhi')
