...
Insert into LMS_BOOK_ISSUE (BOOK_ISSUE_NO,MEMBER_ID,BOOK_CODE,DATE_ISSUE,DATE_RETURN,DATE_RETURNED,FINE_RANGE) values (17,'LM005','BL000005',to_date('05-05-12','DD-MM-RR'),to_date('20-05-12','DD are roles and policies in aws-MM-RR'),to_date('20-05-12','DD-MM-RR'),null);
...
Insert into LMS_BOOK_ISSUE (BOOK_ISSUE_NO,MEMBER_ID,BOOK_CODE,DATE_ISSUE,DATE_RETURN,DATE_RETURNED,FINE_RANGE) values (23,'LM005','BL000002 are roles and policies in aws',to_date('05-05-13','DD-MM-RR'),to_date('20-05-13','DD-MM-RR'),to_date('20-05-13','DD-MM-RR'),null);
...
select
BOOK_TITLE,extract(year from PUBLISH_DATE),PUBLICATION,CATEGORY,decode(CATEGORY,'JAVA','object_oriented_lang','C','procedural_lang')TYPE_OF_LANG
from lms_book_details where extract(year from PUBLISH_DATE) >= 2005 or trim(PUBLICATION) != 'Tata Mcgraw Hill';
