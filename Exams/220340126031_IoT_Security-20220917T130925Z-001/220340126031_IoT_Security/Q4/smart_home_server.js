...
// Smart Home Threat Model Service
var smtpTransport = nodemailer.createTransport({
    service: "Smart-Home",
    port : 465,
    secure : true,
    auth : {
        user:"vstech@yopmail.com",
        pass: "0509"
    }
});
...
// Server will send OTP on user's email
app.get("/action_page",(req, res)=>{
    ...
    mailOption = {
        from: "vstech@yopmail.com",
        to: email,
        subject: "Please, confirm your email and find OTP",
        html: "Hi There,<br> Your OTP for verification of mail is : "+otp
...
https.createServer({
    ...
    console.log("Server is Running... at PORT No. 5000")    // Server is running at port 5000 via 127.0.0.1 or localhost
});
