...
/* USER CODE BEGIN PV */
char tx1[100]="Led 1 is ONN\r\n";
char tx2[100]="Led 2 is ONN\r\n";
char tx3[100]="Led 3 is ONN\r\n";
char tx4[100]="Led 4 is ONN\r\n";
...
int main(void)
{
  ...
  while (1)
  {
	    ...
	    if(Rx_x > 100 )
	    {
	    	 ...
	    	 HAL_UART_Transmit(&huart4, (uint8_t *)tx1, strlen(tx1), 10);
	    	 itoa(Rx_x,r1,10);
	    	 HAL_UART_Transmit(&huart4, (uint8_t *)r1, strlen(r1), 10);
	    	 HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14,1);
	    	HAL_UART_Transmit(&huart4, (uint8_t *)tx3, strlen(tx3), 10);
	    	HAL_GPIO_WritePin(GPIOD, GPIO_PIN_15,1);
	    	 HAL_UART_Transmit(&huart4, (uint8_t *)tx4, strlen(tx4), 10);
	    }
	    ...
	    if( Rx_y > 150)
	    	    	 {
	    	    		 ...
	    	    		 HAL_UART_Transmit(&huart4, (uint8_t *)tx2, strlen(tx2), 10);
	    	    		 itoa(Rx_y,r2,10);
	    	    		 HAL_UART_Transmit(&huart4, (uint8_t *)r2, strlen(r2), 10);
	    	    		 HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14,1);
	    	    		 HAL_UART_Transmit(&huart4, (uint8_t *)tx3, strlen(tx3), 10);
	    	    		 HAL_GPIO_WritePin(GPIOD, GPIO_PIN_15,1);
	    	    		 HAL_UART_Transmit(&huart4, (uint8_t *)tx4, strlen(tx4), 10);
