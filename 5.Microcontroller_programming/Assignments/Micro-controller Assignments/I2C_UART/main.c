...
/* USER CODE BEGIN PV */
 ...
 uint8_t aTxBuffer[2];
 uint8_t aRxBuffer[2];
 char tx1[30]= "LED 1 was pressed\r\n";
 char tx2[30]= "LED 2 was pressed\r\n";
 char tx3[30]= "LED 3 was pressed\r\n";
 char tx4[30]= "LED 4 was pressed\r\n";
/* USER CODE END PV */
...
void LED_Display(uint8_t LedStatus)
{
  ...
  switch(LedStatus)
  {
    ...
    HAL_UART_Transmit(&huart5, (uint8_t *)tx1, strlen(tx1), 10);
      break;

    case (2):
      /* Turn ON LED2 */
		HAL_GPIO_WritePin(GPIOD, GPIO_PIN_13, GPIO_PIN_SET);
    HAL_UART_Transmit(&huart5, (uint8_t *)tx2, strlen(tx2), 10);
      break;

    case (3):
      /* Turn ON LED3 */
		HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14, GPIO_PIN_SET);
    HAL_UART_Transmit(&huart5, (uint8_t *)tx3, strlen(tx3), 10);
      break;

    case (4):
      /* Turn ON LED4 */
		HAL_GPIO_WritePin(GPIOD, GPIO_PIN_15, GPIO_PIN_SET);
    HAL_UART_Transmit(&huart5, (uint8_t *)tx4, strlen(tx4), 10);
      break;
    default:
      break;
  }
